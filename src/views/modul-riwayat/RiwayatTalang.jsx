...
import { useRiwayatTalang } from "../../hooks/useHistory";
import { helper } from "../../utils/helper";

function RiwayatTalang() {
  const [date, setDate] = useState();
  const [page, setPage] = useState(1);
  const [search, setSearch] = useState("");
  const { data, isFetching } = useRiwayatTalang(page);
  const filterData = () => {
  ...
  return (
    <>
      <h2 className="intro-y text-lg font-medium mt-10">Riwayat Talang</h2>
