...
import { useCreateProduk } from "../../../hooks/useProduct";
const schema = yup
  .object({
...
function Create({ modal, setModal }) {
  ...
  const { mutate, isLoading } = useCreateProduk((data) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <ModalHeader>
            <h2 className="font-medium text-base mr-auto">Create Produk</h2>
          </ModalHeader>
          <ModalBody className="grid grid-cols-12 gap-4 gap-y-3">
            <div className="col-span-12">
              ...
              />
              {errors.nama_produk && (
                <div className="text-danger mt-2">{errors.nama_produk.message}</div>
              )}
            </div>
            <div className="col-span-12">
            ...
            <div className="col-span-12">
              ...
              {errors.warning_stok_box && (
                <div className="text-danger mt-2">{errors.warning_stok_box.message}</div>
              )}
            </div>
            <div className="col-span-12">
              ...
              {errors.warning_stok_talang && (
                <div className="text-danger mt-2">{errors.warning_stok_talang.message}</div>
              )}
            </div>
          </ModalBody>
          <ModalFooter>
